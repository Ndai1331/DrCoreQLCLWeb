...
namespace CoreAdminWeb.Services
{
    ...
    public class QLCLPhatTrienThiTruongSanPhamService(IHttpClientService _httpClientService) : IQLCLPhatTrienThiTruongSanPhamService
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLPhatTrienThiTruongSanPhamModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLPhatTrienThiTruongSanPhamModel>>>(url);
        ...
        public async Task<RequestHttpResponse<QLCLPhatTrienThiTruongSanPhamModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLPhatTrienThiTruongSanPhamModel>>($"items/{_collection}/{id}?fields={Fields}");
        ...
        public async Task<RequestHttpResponse<List<QLCLPhatTrienThiTruongSanPhamModel>>> CreateAsync(List<QLCLPhatTrienThiTruongSanPhamModel> model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<List<QLCLPhatTrienThiTruongSanPhamModel>>>($"items/{_collection}?fields={Fields}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(List<QLCLPhatTrienThiTruongSanPhamModel> model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<QLCLPhatTrienThiTruongSanPhamModel>>>($"items/{_collection}?fields={Fields}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(List<QLCLPhatTrienThiTruongSanPhamModel> model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<QLCLPhatTrienThiTruongSanPhamModel>>>($"items/{_collection}?fields={Fields}", model.Select(c => new { id = c.id, deleted = true }));

...
{
    public class QLCLPhatTrienThiTruongService(IHttpClientService _httpClientService) : IBaseService<QLCLPhatTrienThiTruongModel>
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLPhatTrienThiTruongModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLPhatTrienThiTruongModel>>>(url);
        ...
        public async Task<RequestHttpResponse<QLCLPhatTrienThiTruongModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLPhatTrienThiTruongModel>>($"items/{_collection}/{id}?fields={Fields}");
        ...
        public async Task<RequestHttpResponse<QLCLPhatTrienThiTruongModel>> CreateAsync(QLCLPhatTrienThiTruongModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<QLCLPhatTrienThiTruongCRUDResponseModel>>($"items/{_collection}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(QLCLPhatTrienThiTruongModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLPhatTrienThiTruongCRUDModel>>($"items/{_collection}/{model.id}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(QLCLPhatTrienThiTruongModel model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLPhatTrienThiTruongCRUDModel>>($"items/{_collection}/{model.id}", new { deleted = true });

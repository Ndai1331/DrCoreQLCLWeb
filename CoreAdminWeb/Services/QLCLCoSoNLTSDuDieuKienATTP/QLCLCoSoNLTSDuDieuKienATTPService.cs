...
{
    public class QLCLCoSoNLTSDuDieuKienATTPService(IHttpClientService _httpClientService) : IBaseService<QLCLCoSoNLTSDuDieuKienATTPModel>
    {
        ...
        private const string Fields = "*,user_created.last_name,user_created.first_name,user_updated.last_name,user_updated.first_name"
            ...
            +",dia_chi,chi_tiets.id, chi_tiets.sort, chi_tiets.deleted ,chi_tiets.san_pham.id,chi_tiets.san_pham.name";
        ...
        public async Task<RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPModel>>>(url);
        ...
        public async Task<RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPModel>>($"items/{_collection}/{id}?fields={Fields}");

                return response.IsSuccess
                    ? new RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPModel> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPModel>> CreateAsync(QLCLCoSoNLTSDuDieuKienATTPModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPCRUDResponseModel>>($"items/{_collection}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(QLCLCoSoNLTSDuDieuKienATTPModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPCRUDModel>>($"items/{_collection}/{model.id}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(QLCLCoSoNLTSDuDieuKienATTPModel model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPCRUDModel>>($"items/{_collection}/{model.id}", new { deleted = true });

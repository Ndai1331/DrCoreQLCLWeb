...
namespace CoreAdminWeb.Services
{
    ...
    public class QLCLCoSoNLTSDuDieuKienATTPSanPhamService(IHttpClientService _httpClientService) : IQLCLCoSoNLTSDuDieuKienATTPSanPhamService
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>>>(url);

                return response.IsSuccess
                    ? new RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>>($"items/{_collection}/{id}?fields={Fields}");

                return response.IsSuccess
                    ? new RequestHttpResponse<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>>> CreateAsync(List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel> model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>>>($"items/{_collection}?fields={Fields}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel> model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>>>($"items/{_collection}?fields={Fields}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel> model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<QLCLCoSoNLTSDuDieuKienATTPSanPhamModel>>>($"items/{_collection}?fields={Fields}", model.Select(c => new { id = c.id, deleted = true }));

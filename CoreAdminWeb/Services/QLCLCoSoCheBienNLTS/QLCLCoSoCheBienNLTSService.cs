...
{
    public class QLCLCoSoCheBienNLTSService(IHttpClientService _httpClientService) : IBaseService<QLCLCoSoCheBienNLTSModel>
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLCoSoCheBienNLTSModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLCoSoCheBienNLTSModel>>>(url);
        ...
        public async Task<RequestHttpResponse<QLCLCoSoCheBienNLTSModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLCoSoCheBienNLTSModel>>($"items/{_collection}/{id}?fields={Fields}");

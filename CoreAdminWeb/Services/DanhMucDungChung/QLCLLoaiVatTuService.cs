...
{
    public class QLCLLoaiVatTuService(IHttpClientService _httpClientService) : IBaseService<QLCLLoaiVatTuModel>
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLLoaiVatTuModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLLoaiVatTuModel>>>(url);
        ...
        public async Task<RequestHttpResponse<QLCLLoaiVatTuModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLLoaiVatTuModel>>($"items/{_collection}/{id}?fields={Fields}");
        ...
        public async Task<RequestHttpResponse<QLCLLoaiVatTuModel>> CreateAsync(QLCLLoaiVatTuModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<QLCLLoaiVatTuCRUDModel>>($"items/{_collection}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(QLCLLoaiVatTuModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLLoaiVatTuCRUDModel>>($"items/{_collection}/{model.id}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(QLCLLoaiVatTuModel model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLLoaiVatTuCRUDModel>>($"items/{_collection}/{model.id}", new { deleted = true });

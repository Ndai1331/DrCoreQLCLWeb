...
{
    public class QLCLHinhThucXuPhatService(IHttpClientService _httpClientService) : IBaseService<QLCLHinhThucXuPhatModel>
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLHinhThucXuPhatModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLHinhThucXuPhatModel>>>(url);
        ...
        public async Task<RequestHttpResponse<QLCLHinhThucXuPhatModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLHinhThucXuPhatModel>>($"items/{_collection}/{id}?fields={Fields}");
        ...
        public async Task<RequestHttpResponse<QLCLHinhThucXuPhatModel>> CreateAsync(QLCLHinhThucXuPhatModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<QLCLHinhThucXuPhatCRUDModel>>($"items/{_collection}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(QLCLHinhThucXuPhatModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLHinhThucXuPhatCRUDModel>>($"items/{_collection}/{model.id}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(QLCLHinhThucXuPhatModel model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLHinhThucXuPhatCRUDModel>>($"items/{_collection}/{model.id}", new { deleted = true });

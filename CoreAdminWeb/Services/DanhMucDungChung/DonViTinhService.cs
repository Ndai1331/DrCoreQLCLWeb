...
{
    public class DonViTinhService(IHttpClientService _httpClientService) : IBaseService<DonViTinhModel>
    {
        ...
        public async Task<RequestHttpResponse<List<DonViTinhModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<DonViTinhModel>>>(url);
        ...
        public async Task<RequestHttpResponse<DonViTinhModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<DonViTinhModel>>($"items/{_collection}/{id}?fields={Fields}");
        ...
        public async Task<RequestHttpResponse<DonViTinhModel>> CreateAsync(DonViTinhModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<DonViTinhCRUDModel>>($"items/{_collection}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(DonViTinhModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<DonViTinhCRUDModel>>($"items/{_collection}/{model.id}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(DonViTinhModel model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<DonViTinhCRUDModel>>($"items/{_collection}/{model.id}", new { deleted = true });

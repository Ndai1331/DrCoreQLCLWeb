...
{
    public class QLCLSanPhamSanXuatService(IHttpClientService _httpClientService) : IBaseService<QLCLSanPhamSanXuatModel>
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLSanPhamSanXuatModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLSanPhamSanXuatModel>>>(url);
        ...
        public async Task<RequestHttpResponse<QLCLSanPhamSanXuatModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLSanPhamSanXuatModel>>($"items/{_collection}/{id}?fields={Fields}");
        ...
        public async Task<RequestHttpResponse<QLCLSanPhamSanXuatModel>> CreateAsync(QLCLSanPhamSanXuatModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<QLCLSanPhamSanXuatCRUDModel>>($"items/{_collection}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(QLCLSanPhamSanXuatModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLSanPhamSanXuatCRUDModel>>($"items/{_collection}/{model.id}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(QLCLSanPhamSanXuatModel model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLSanPhamSanXuatCRUDModel>>($"items/{_collection}/{model.id}", new { deleted = true });

...
namespace CoreAdminWeb.Services
{
    ...
    public class QLCLTinhHinhSXKDNLTSNguyenLieuService(IHttpClientService _httpClientService) : IQLCLTinhHinhSXKDNLTSNguyenLieuService
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSNguyenLieuModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSNguyenLieuModel>>>(url);

                return response.IsSuccess
                    ? new RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSNguyenLieuModel>> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<QLCLTinhHinhSXKDNLTSNguyenLieuModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLTinhHinhSXKDNLTSNguyenLieuModel>>($"items/{_collection}/{id}?fields={Fields}");

                return response.IsSuccess
                    ? new RequestHttpResponse<QLCLTinhHinhSXKDNLTSNguyenLieuModel> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSNguyenLieuModel>>> CreateAsync(List<QLCLTinhHinhSXKDNLTSNguyenLieuModel> model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSNguyenLieuModel>>>($"items/{_collection}?fields={Fields}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(List<QLCLTinhHinhSXKDNLTSNguyenLieuModel> model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSNguyenLieuModel>>>($"items/{_collection}?fields={Fields}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(List<QLCLTinhHinhSXKDNLTSNguyenLieuModel> model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSNguyenLieuModel>>>($"items/{_collection}?fields={Fields}", model.Select(c => new { id = c.id, deleted = true }));

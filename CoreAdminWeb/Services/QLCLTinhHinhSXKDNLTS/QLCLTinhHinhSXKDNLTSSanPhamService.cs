...
namespace CoreAdminWeb.Services
{
    ...
    public class QLCLTinhHinhSXKDNLTSSanPhamService(IHttpClientService _httpClientService) : IQLCLTinhHinhSXKDNLTSSanPhamService
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSSanPhamModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSSanPhamModel>>>(url);

                return response.IsSuccess
                    ? new RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSSanPhamModel>> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<QLCLTinhHinhSXKDNLTSSanPhamModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLTinhHinhSXKDNLTSSanPhamModel>>($"items/{_collection}/{id}?fields={Fields}");

                return response.IsSuccess
                    ? new RequestHttpResponse<QLCLTinhHinhSXKDNLTSSanPhamModel> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSSanPhamModel>>> CreateAsync(List<QLCLTinhHinhSXKDNLTSSanPhamModel> model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSSanPhamModel>>>($"items/{_collection}?fields={Fields}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(List<QLCLTinhHinhSXKDNLTSSanPhamModel> model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSSanPhamModel>>>($"items/{_collection}?fields={Fields}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(List<QLCLTinhHinhSXKDNLTSSanPhamModel> model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSSanPhamModel>>>($"items/{_collection}?fields={Fields}", model.Select(c => new { id = c.id, deleted = true }));

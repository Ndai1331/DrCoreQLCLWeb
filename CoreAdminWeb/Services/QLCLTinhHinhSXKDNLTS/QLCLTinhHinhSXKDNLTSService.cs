...
{
    public class QLCLTinhHinhSXKDNLTSService(IHttpClientService _httpClientService) : IBaseService<QLCLTinhHinhSXKDNLTSModel>
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLTinhHinhSXKDNLTSModel>>>(url);
        ...
        public async Task<RequestHttpResponse<QLCLTinhHinhSXKDNLTSModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLTinhHinhSXKDNLTSModel>>($"items/{_collection}/{id}?fields={Fields}");
        ...
        public async Task<RequestHttpResponse<QLCLTinhHinhSXKDNLTSModel>> CreateAsync(QLCLTinhHinhSXKDNLTSModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<QLCLTinhHinhSXKDNLTSCRUDResponseModel>>($"items/{_collection}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(QLCLTinhHinhSXKDNLTSModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLTinhHinhSXKDNLTSCRUDModel>>($"items/{_collection}/{model.id}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(QLCLTinhHinhSXKDNLTSModel model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLTinhHinhSXKDNLTSCRUDModel>>($"items/{_collection}/{model.id}", new { deleted = true });

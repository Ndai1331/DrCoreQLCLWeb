...
{
    public class QLCLKiemTraHauKiemATTPService(IHttpClientService _httpClientService) : IBaseService<QLCLKiemTraHauKiemATTPModel>
    {
        ...
        public async Task<RequestHttpResponse<List<QLCLKiemTraHauKiemATTPModel>>> GetAllAsync(string query)
        {
            try
            {
                ...
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<List<QLCLKiemTraHauKiemATTPModel>>>(url);

                return response.IsSuccess
                    ? new RequestHttpResponse<List<QLCLKiemTraHauKiemATTPModel>> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<QLCLKiemTraHauKiemATTPModel>> GetByIdAsync(string id)
        {
            ...
            try
            {
                var response = await _httpClientService.GetAPIAsync<RequestHttpResponse<QLCLKiemTraHauKiemATTPModel>>($"items/{_collection}/{id}?fields={Fields}");

                return response.IsSuccess
                    ? new RequestHttpResponse<QLCLKiemTraHauKiemATTPModel> { Data = response.Data?.Data, Meta = response.Data?.Meta }
        ...
        public async Task<RequestHttpResponse<QLCLKiemTraHauKiemATTPModel>> CreateAsync(QLCLKiemTraHauKiemATTPModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PostAPIAsync<RequestHttpResponse<QLCLKiemTraHauKiemATTPCRUDResponseModel>>($"items/{_collection}", createModel);
        ...
        public async Task<RequestHttpResponse<bool>> UpdateAsync(QLCLKiemTraHauKiemATTPModel model)
        {
            ...
            try
            {
                ...
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLKiemTraHauKiemATTPCRUDModel>>($"items/{_collection}/{model.id}", updateModel);
        ...
        public async Task<RequestHttpResponse<bool>> DeleteAsync(QLCLKiemTraHauKiemATTPModel model)
        {
            ...
            try
            {
                var response = await _httpClientService.PatchAPIAsync<RequestHttpResponse<QLCLKiemTraHauKiemATTPCRUDModel>>($"items/{_collection}/{model.id}", new { deleted = true });

        ...
        public async Task<RequestHttpResponse<FileModel>> UploadFileAsync(IBrowserFile file, FileCRUDModel? model = null)
        {
            ...
            try
            {
                ...
                if (result.IsSuccess && result.Data != null)
                {
                    ...
                    {
                        response.Data.filename_disk = $"{_appSettings.Value.BaseUrl}assets/{response.Data.filename_disk}";
                        response.Data.filename_download = $"{_appSettings.Value.BaseUrl}assets/{response.Data.filename_download}";
                        if (model != null)
                        {

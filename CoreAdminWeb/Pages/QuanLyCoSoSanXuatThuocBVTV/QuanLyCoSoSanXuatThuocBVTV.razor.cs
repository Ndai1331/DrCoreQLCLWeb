...
namespace CoreAdminWeb.Pages.QuanLyCoSoSanXuatThuocBVTV
{
                                           ...
                                           IBaseService<QLCLLoaiHinhKinhDoanhModel> QLCLLoaiHinhKinhDoanhService) : BlazorCoreBase
    {
        ...
        private void OpenAddOrUpdateModal(QuanLyCoSoSanXuatThuocBVTVModel? item)
        {
            _titleAddOrUpdate = item != null ? "Sửa" : "Thêm mới";
            SelectedItem = item != null ? item.DeepClone() : new QuanLyCoSoSanXuatThuocBVTVModel();

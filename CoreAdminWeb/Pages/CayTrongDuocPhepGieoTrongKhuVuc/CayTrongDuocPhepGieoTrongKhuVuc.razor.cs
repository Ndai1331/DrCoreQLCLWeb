...
namespace CoreAdminWeb.Pages.CayTrongDuocPhepGieoTrongKhuVuc
{
    public partial class CayTrongDuocPhepGieoTrongKhuVuc(IBaseService<CayTrongDuocPhepGieoTrongKhuVucModel> MainService,
                                              ...
                                              IBaseService<XaPhuongModel> XaPhuongService) : BlazorCoreBase
    {
        ...
        private List<CayTrongDuocPhepGieoTrongKhuVucModel> MainModels { get; set; } = new();
        private bool openDeleteModal = false;
        private bool openAddOrUpdateModal = false;

        private CayTrongDuocPhepGieoTrongKhuVucModel SelectedItem { get; set; } = new CayTrongDuocPhepGieoTrongKhuVucModel();
        ...
        private async Task LoadData()
        {
            ...
            if (result.IsSuccess)
            {
                MainModels = result.Data ?? new List<CayTrongDuocPhepGieoTrongKhuVucModel>();
                if (result.Meta != null)
                {
            ...
            {
                MainModels = new List<CayTrongDuocPhepGieoTrongKhuVucModel>();
            }
        }
        ...
        private void OpenDeleteModal(CayTrongDuocPhepGieoTrongKhuVucModel item)
        {
            SelectedItem = item;
        ...
        {
            SelectedItem = new CayTrongDuocPhepGieoTrongKhuVucModel();

            openDeleteModal = false;
        }

        private async Task OpenAddOrUpdateModal(CayTrongDuocPhepGieoTrongKhuVucModel? item)
        {
            _titleAddOrUpdate = item != null ? "Sửa" : "Thêm mới";
            SelectedItem = item != null ? item : new CayTrongDuocPhepGieoTrongKhuVucModel();

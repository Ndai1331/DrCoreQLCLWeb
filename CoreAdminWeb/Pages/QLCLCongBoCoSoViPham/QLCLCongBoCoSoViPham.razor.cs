...
{
    public partial class QLCLCongBoCoSoViPham(IBaseService<QLCLCoSoViPhamATTPModel> MainService,
                                              ...
                                              IBaseService<XaPhuongModel> XaPhuongService) : BlazorCoreBase
    {
        ...
        private bool openCongBoModal { get; set; } = false;
        private QLCLCoSoViPhamATTPModel? _selectedItem { get; set; }
        ...
        private void OpenCongBoModal(QLCLCoSoViPhamATTPModel item)
        {
            _selectedItem = item;
            openCongBoModal = true;
        }

        private void CloseCongBoModal()
        {
            openCongBoModal = false;
        }

        private async Task OnCongBo()
        {
            ...
            {
                AlertService.ShowAlert(result.Errors.FirstOrDefault()?.Message ?? "Có lỗi xảy ra", "danger");
            }
        }
    }
}

...
namespace CoreAdminWeb.Helpers
{
    public static class ReflectionHelper
    {
        ...
        {
            if (EqualityComparer<TValue1>.Default.Equals(value1, default) || EqualityComparer<TValue2>.Default.Equals(value2, default) || string.IsNullOrWhiteSpace(fieldName))
            {
                return;
            }
        ...
        {
            if (EqualityComparer<TTarget>.Default.Equals(target, default) || string.IsNullOrWhiteSpace(fieldName))
            {
                return;
            }
